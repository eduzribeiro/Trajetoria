...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    private double tns,tns_aux,dt,Db,Db2,DbDecidido,Sx,Sy,Sz;
    ...
    detectordepausa_Inicio_Teste DETEC2;
    ...
    public void onClickIniciar(View v){
        ...
        DETEC2 = new detectordepausa_Inicio_Teste("/sdcard/Download/CoeficientesFiltros/ValoresH_detectorpausa_inicio.dat");
        DEC = new decide_detector();
        ...
        if (aux) {
            ...
            if (estadoDoSensor.todosAtivos()) {
                ...
                if(OFFSET<COUNTER) {
                    ...
                    //DetectorPausa Inicio - TESTE

                    Db2 = DETEC2.detector_inicio(a,ruido0);

                    //Matriz

                    M = MA.matriz_transf(DbDecidido,w,dt);
                    ...
                    DbDecidido = DEC.decidido(Db,Db2);

                    //Integral

                    INT.integra_rt(dt,a_n2,DbDecidido);
