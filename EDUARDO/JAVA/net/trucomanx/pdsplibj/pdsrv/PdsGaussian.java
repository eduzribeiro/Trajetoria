 ...
 *
 * <br><br>
 * <center><img src="{@docRoot}/data/imagenes/PdsGaussian.png" alt="X \sim \mathcal{N}(\mu,\,\sigma^2)"></center><br>
 ...
 * <center><img src="{@docRoot}/data/imagenes/XGaussian.png" width="600" alt="X"></center><br>
 * Isto pode ser visto na sua função de densidade de probabilidade.
 * <center><img src="{@docRoot}/data/imagenes/PDF-Gaussian.png" width="600" alt="f_X(x)=\frac{1}{\sigma\sqrt{2\pi}}\, e^{-\frac{(x - \mu)^2}{2 \sigma^2}}"></center><br>
