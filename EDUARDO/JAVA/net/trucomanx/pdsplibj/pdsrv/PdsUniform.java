 ...
 *
 * <br><br>
 * <center><img src="{@docRoot}/data/imagenes/PdsUniform.png" width="400" alt=" X maior igual a A e menor que B "></center><br>
 *
 * Se a fonte aleatória Uniforme esta distribuída entre 0.0 e 1.0 então:
 * <center><img src="{@docRoot}/data/imagenes/XUniform.png" width="600" alt="X"></center><br>
 * Isto pode ser visto na sua função de densidade de probabilidade.
 * <center><img src="{@docRoot}/data/imagenes/PDF-Uniform.png" width="600" alt="f_X(x)=1"></center><br>
