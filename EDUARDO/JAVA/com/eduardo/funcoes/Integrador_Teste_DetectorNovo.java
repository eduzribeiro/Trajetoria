...
public class Integrador_Teste_DetectorNovo {

	public double Vx,Vy,Vz,Sx,Sy,Sz;


	public Integrador_Teste_DetectorNovo(int initval){
    ...
    //Vz: Deslocamento no eixo z [1x1]
   	...
   	public double integra_detectorNovo(double dt, PdsMatrix a_n2, double Db, double Db2) {   
	...
	public static void main(String[] args) {
		...
		Integrador_Teste_DetectorNovo var = new Integrador_Teste_DetectorNovo(0);
		...
		for (int i=0;i<5;i++){
			...
			var.integra_detectorNovo(dt,an_2,Db,Db2);
