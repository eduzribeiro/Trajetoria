...
public class detectordepausa_rt {
	...
	public static void main(String[] args) {
		...
		for (int i=0;i<10;i++){
			...
			an2.SetValue(0,0,0.001);
			an2.SetValue(0,1,0.001);
			an2.SetValue(0,2,0.001);

			Db = var.detector_pausa(an2,ruido);
			
			System.out.println("["+i+"]Db: "+Db);
		}
